...
존재하는 곳은 **본인의 브라우저와 본인이 선택한 GitHub 저장소뿐**입니다. 전체 구현은
[GitHub 저장소](https://github.com/zidell/github-issue-notes)에서 직접 확인할 수
있습니다.
...
잠금 숫자는 저장하지 않고 앱 메모리에서 한 시간 동안만 재사용합니다. 모든 잠금
노트에 같은 숫자를 사용해야 하며, 숫자나 `VITE_NOTE_LOCK_PEPPER` 중 하나라도
잊으면 내용을 복구할 수 없습니다.
